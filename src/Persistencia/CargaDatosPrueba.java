...
public class CargaDatosPrueba {
    ...
    private String[][] listasPorDefecto = {
        {"LD1", "Noche De La Nostalgia", "PCL", "Noche De La Nostalgia.jpg", "23", "8", "2015"},
        {"LD2", "Rock En Español", "RKL", "", "15", "6", "2016"},
        {"LD3", "Musica Clasica", "CLA", "Musica Clasica.jpg", "27", "1", "2016"}
    };

    // Listas de Reproduccion Particulares (Ref cliente, Ref, Nombre, Publica, Imagen)
    private String[][] listasParticulares = {
        {"VC", "LP1", "Musica Inspiradora", "S", "Musica Inspiradora.jpg", "23", "12", "2015"},
        {"SO", "LP2", "De Todo Un Poco", "S", "", "2", "6", "2016"},
        {"WW", "LP3", "Para Cocinar", "N", "Para Cocinar.jpg", "3", "4", "2015"},
        {"ML", "LP4", "Para Las Chicas", "S", "", "15", "1", "2016"},
        {"CB", "LP5", "Fiesteras", "S", "Fiesteras.jpg", "7", "8", "2016"},
        {"CB", "LP6", "Mis Favoritas", "N", "", "20", "10", "2015"}
    };
    ...
    public ArrayList<String[]> cargarListasParticulares() {
        try {
            ...
            while (listas.next()) {
                String[] fecha = listas.getString(7).split("-");
                res.add(new String[]{String.valueOf(listas.getInt(1)), listas.getString(2), listas.getString(3), listas.getString(4), listas.getString(5), listas.getString(6), fecha[0], fecha[1], fecha[2]});
            }
    ...
    public ArrayList<String[]> cargarListasDefecto() {
        try {
            ...
            ResultSet listas = l.executeQuery();
            while (listas.next()) {
                String[] fecha = listas.getString(5).split("-");
                res.add(new String[]{String.valueOf(listas.getString(1)), listas.getString(2), listas.getString(3), listas.getString(4), fecha[0], fecha[1], fecha[2]});
            }
